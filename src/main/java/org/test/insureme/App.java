...
public class App 
{
   ...
   // System.setProperty("webdriver.chrome.driver", "/Users/shubham/Documents/softwares/chrome-driver/chromedriver");
    ...
    driver.get("http://3.25.67.144:8087/contact.html");	
    ...
    //enter details
    //input name
    driver.findElement(By.id("inputName")).sendKeys("prasanth");
    Thread.sleep(1000);
    driver.findElement(By.id("inputNumber")).sendKeys("999999999");
    Thread.sleep(1000);
    driver.findElement(By.id("inputMail")).sendKeys("pandu.com");
    Thread.sleep(1000);
